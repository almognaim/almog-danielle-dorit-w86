...
<main class="page-content" id="page-content-client">
...
<script>
    ...
    $('#addNewItem').click(function(e) {
        e.preventDefault();
        alert('section for add new item');
        $("#container-wrapper-for-add-newFields").append('<div class="wrapper-for-add-newFields row"><div class="col-lg-9 col-12"><div class="form-group text-right" id="partsChnage-wrapper"><select id="partsChnage" class="custom-select"name="partsChnage"><option>מוצר</option><option>מוצר</option></select></div></div><div class="col-lg-2 col-12"><div class="form-group text-right"><input class="form-control text-center" type="number" value="1" id="number-input"></div></div><div class="col-lg-1 col-12"><div class="form-group text-center"><span><i class="fas fa-times"></i></span></div></div></div></div>');
    });
</script>
