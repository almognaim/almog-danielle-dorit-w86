...
<script
    src="https://www.paypal.com/sdk/js?client-id=AVCZl-pF5AzP0QScG4lB1qbBYkzTQ74PWWKvdW_WTz9H-agRiFTTwi_aj5ciztU953sQpwl4zbRClGD9">
</script>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php
                $sql = "select clients.* , clients_fixes.fixAbout, clients_fixes.fixDescription from clients_fixes 
                ...
                if (mysqli_num_rows($result) > 0) {
                    foreach (mysqli_fetch_assoc($result) as $key => $value){
                        if ($key != 'id' && $key != 'fixAbout' && $key != 'fixDescription'){
